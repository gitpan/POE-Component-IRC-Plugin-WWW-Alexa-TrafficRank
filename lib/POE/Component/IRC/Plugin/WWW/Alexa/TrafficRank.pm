...
(it defaults to C<irc_alexa_traffic_rank>) will recieve input
...
Unless an error occured the C<rank> key will be present and it's value
...
If an error occured, the C<rank> key will be missing and the C<error>
...
Please report any bugs or feature requests to C<bug-poe-component-irc-plugin-www-alexa-trafficrank at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-IRC-Plugin-WWW-Alexa-TrafficRank>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-IRC-Plugin-WWW-Alexa-TrafficRank>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-IRC-Plugin-WWW-Alexa-TrafficRank>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-IRC-Plugin-WWW-Alexa-TrafficRank>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-IRC-Plugin-WWW-Alexa-TrafficRank>
